...
(defun create-spacemacs-theme (variant theme-name)
  (dyn-let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ...
        (base          (if (eq variant 'dark) (if (true-color-p) "#d2d2d2" "#d2d2d2") (if (true-color-p) "#000000" "#000000")))
        ...
        (comment-bg    (if (eq variant 'dark) (if (true-color-p) "#292e34" "#262626") (if (true-color-p) "#fdf3dc" "#ffffff")))
