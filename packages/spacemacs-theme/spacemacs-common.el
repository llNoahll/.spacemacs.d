...
(defun create-spacemacs-theme (variant theme-name)
  (dyn-let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ...
        (bg5           (if (eq variant 'dark) (if (true-color-p) "#25232c" "#585858") (if (true-color-p) "#e7e7fc" "#d7d7ff")))
        (bg6           (if (eq variant 'dark) (if (true-color-p) "#2f2f3a" "#585858") (if (true-color-p) "#ddeeff" "#d7d7ff")))
